<template>
  <AdminForm
    ...
    :page-name="$t('pageHeadings.reservations.create reservation')"
    :short-desc="$t('pageHeadings.reservations.create a new reservation')"
  >
...
const submitForm = async () => {
  await fetchDataStore.createInstance("reservations", form);
