  ...
  <AdminForm v-if="can('edit instances') && can('manage instructors')"
    ...
    <form id="editUserForm" class="row gap-1 py-1 text-start needs-validation">
          ...
          <div class="row">
            <div class="col-12">
              <div class="flex flex-column gap-1">
                ...
                <Dropdown v-model="instance.user"
                          @update:modelValue="value => { instance.user_person_code = value.person_code }"
                          :options="userList" filter resetFilterOnHide
      ...
      <div class="col-12">
        ...
        <small class="text-secondary"><i class="bi bi-info-circle me-1" />{{ $t(`table.info.max_characters`, { total: 100 }) }}</small>
